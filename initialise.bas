...
'#InitD3D
'# Creates a 3d scene with a boolean input for windowed or fullscreen
'# (800x600x16) and an hWnd to display to.  Checks that system can
'# use hardware rendering also.
...
If windowed = True Then
    ...
    Else
        ...
        'the DirectX features, but is slower than would possibly be
        'tolerable.
